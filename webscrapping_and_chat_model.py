...
persistent_directory = os.path.join(db_dir, "chroma_db_firecra")
...
# Step 1: Crawl the website using FireCrawlLoader
    ...
    loader = FireCrawlLoader(
        api_key="fc-1319f079dab2413882b8754b75a63bc6", url="https://en.wikipedia.org/wiki/Samsung", mode="scrape")
    docs = loader.load()
